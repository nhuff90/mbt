...
import ta4jexamples.backtesting.probability.OmarHighIsOpeningDriveHighTrendDownBacktest;
import ta4jexamples.backtesting.probability.OmarLowIsOpeningDriveLowTrendUpBacktest;
...
public class OmarHighLowTrendFromOpeningDriveBacktest {
...
//        BarSeries series = CsvBarsLoader.loadEs1MinSeries();
        ...
        for(Double rangeMultiplierTakeProfit: rangeMultiplierTakeProfitList) {
            // By AM Range Close
            TradingRecord omarHighTrendDownAmRangeTradingRecord = OmarHighIsOpeningDriveHighTrendDownBacktest.runOmarTradingRecord(series,
                    rangeMultiplierTakeProfit, MarketTime.AM_END_TIME);
            resultsAnalysisOmarHighWithRowNamesAmRange.add(new ResultsAnalysisWithRowName(series, omarHighTrendDownAmRangeTradingRecord,
                    "% chance " + rangeMultiplierTakeProfit + "x OpeningDrive Range By AM Range End"));

            TradingRecord omarLowIsTrendUpAmRangeTradingRecord = OmarLowIsOpeningDriveLowTrendUpBacktest.runOmarTradingRecord(series,
                    rangeMultiplierTakeProfit, MarketTime.AM_END_TIME);
            resultsAnalysisOmarLowWithRowNamesAmRange.add(new ResultsAnalysisWithRowName(series, omarLowIsTrendUpAmRangeTradingRecord,
                    "% chance " + rangeMultiplierTakeProfit + "x OpeningDrive Range By AM Range End"));

            // By RTH Range Close
            TradingRecord omarHighIsTrendDownRthRangeTradingRecord = OmarHighIsOpeningDriveHighTrendDownBacktest.runOmarTradingRecord(series,
                    rangeMultiplierTakeProfit, MarketTime.RTH_END_TIME_1558);
            resultsAnalysisOmarHighWithRowNamesRthRange.add(new ResultsAnalysisWithRowName(series, omarHighIsTrendDownRthRangeTradingRecord,
                    "% chance " + rangeMultiplierTakeProfit + "x OpeningDrive Range By RTH Range End"));

            TradingRecord omarLowIsTrendUpRthRangeTradingRecord = OmarLowIsOpeningDriveLowTrendUpBacktest.runOmarTradingRecord(series,
                    rangeMultiplierTakeProfit, MarketTime.RTH_END_TIME_1558);
            resultsAnalysisOmarLowWithRowNamesRthRange.add(new ResultsAnalysisWithRowName(series, omarLowIsTrendUpRthRangeTradingRecord,
                    "% chance " + rangeMultiplierTakeProfit + "x OpeningDrive Range By RTH Range End"));
         ...
         * Base line
         */
        createAndPrintResults("Omar High = OpeningDrive High [" + startYear + "-" + endYear +"]",
                Arrays.asList("Win%", "EV", "Max Drawdown"), resultsAnalysisOmarHighWithRowNamesAmRange);
        createAndPrintResults("Omar Low = OpeningDrive Low  [" + startYear + "-" + endYear +"]",
         ...
         * Finding edge
         */
        createAndPrintResults("Omar High = OpeningDrive High and below DVWAP/WVWAP [" + startYear + "-" + endYear +"]",
                Arrays.asList("Win%", "EV", "Max Drawdown"), edgeResultsAnalysisOmarHighWithRowNamesAmRange);
        createAndPrintResults("Omar Low = OpeningDrive Low and above DVWAP/WVWAP [" + startYear + "-" + endYear +"]",
...
//        ResultsAnalysisAsTable resultsAnalysisOmarHighAsTableAmRange = new ResultsAnalysisAsTable("Omar High = OpeningDrive High [" + startYear + "-" + endYear + "]",
//                Arrays.asList("Win%", "EV", "Max Drawdown"), resultsAnalysisOmarHighWithRowNamesAmRange);
//        ResultsAnalysisAsTable resultsAnalysisOmarLowAsTableAmRange = new ResultsAnalysisAsTable("Omar Low = OpeningDrive Low [" + startYear + "-" + endYear + "]",
//                Arrays.asList("Win%", "EV", "Max Drawdown"), resultsAnalysisOmarLowWithRowNamesAmRange);
//
//        resultsAnalysisOmarHighAsTableAmRange.print();
//        resultsAnalysisOmarLowAsTableAmRange.print();
//
//        ResultsAnalysisAsTable resultsAnalysisOmarHighAsTableRthRange = new ResultsAnalysisAsTable("Omar High = OpeningDrive High [" + startYear + "-" + endYear + "]",
//                Arrays.asList("Win%", "EV", "Max Drawdown"), resultsAnalysisOmarHighWithRowNamesRthRange);
//        ResultsAnalysisAsTable resultsAnalysisOmarLowAsTableRthRange = new ResultsAnalysisAsTable("Omar Low = OpeningDrive Low [" + startYear + "-" + endYear + "]",
//                Arrays.asList("Win%", "EV", "Max Drawdown"), resultsAnalysisOmarLowWithRowNamesRthRange);
//
//        resultsAnalysisOmarHighAsTableRthRange.print();
//        resultsAnalysisOmarLowAsTableRthRange.print();
    }
