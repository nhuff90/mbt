...
public class MicroBreakoutProbabilitiesTest extends ProbabilityTest {
...
//        BarSeries series = CsvBarsLoader.loadEs1MinSeriesAfterYear(ZonedDateTime.of(LocalDate.of(2020, 1, 1), LocalTime.of(9, 30), ZoneId.of("America/New_York")));
        ...
        MicroBreakoutProbabilitiesTest microBreakoutProbabilitiesTest = new MicroBreakoutProbabilitiesTest();
