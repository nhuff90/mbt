...
public class TrendVsRangeBasedOnSimpleOpenCloseStats extends Stats {
...
//        BarSeries series = CsvBarsLoader.loadEs1MinSeriesSpecificDate( ZonedDateTime.of ( LocalDate.of ( 2023, 2, 13), LocalTime.of ( 9, 30 ), ZoneId.of ( "America/New_York" )));
        ...
        TrendVsRangeBasedOnSimpleOpenCloseStats nHodBy30mPeriodStatsTest = new TrendVsRangeBasedOnSimpleOpenCloseStats();
